...
//Cancel action
aActionsIDs = aActionsIDs + [player addAction[("<img image='\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\transport_ca.paa' width='32' height='32'/> <t color=""#FF0000"">Cancel Action</t>"), "noscript.sqf", 'doCancelAction = true;', 1, false, false, "", 'mutexScriptInProgress']];
...
aActionsIDs = aActionsIDs + [player addAction["<img image='\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\attack_ca.paa' width='32' height='32'/> <t color=""#FF0000"">Open gun store</t>", "[] spawn loadGunStore;", [], 1, false, false, "", '(vehicle player == player) && player distance (nearestObject [player, "C_man_1_1_F"]) < 1']];
aActionsIDs = aActionsIDs + [player addAction["<img image='\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\defend_ca.paa' width='32' height='32'/> <t color=""#FF0000"">Open general store</t>", "[] spawn loadGeneralStore;", [], 1, false, false, "", '(vehicle player == player) && player distance (nearestObject [player, "C_man_polo_6_F"]) < 1']];
