...
for "_i" from 1 to 134 do  
{
	...
	diag_log format["--DEBUG-- [ObjectSpawning2] call findsafepos for (Spawn_%2) with args: [%1, 35, 52, 1, 0, 60 * (pi / 180), 0] --DEBUG--", _pos, _i]; 
    //emd of debug line added by JoSchaap (you should NOT use my debug builds on your server!)
	
	_newpos = [_pos, 35, 52, 1, 0, 60 * (pi / 180), 0] call BIS_fnc_findSafePos;
