...
_vehicles = [];
_vehicles set [0, ["O_Heli_Light_02_armed_F", [2436.24,847.9,0.00133419], 91, _grouphsq] call _createVehicle];
_vehicles set [1, ["O_Heli_Light_02_armed_F", [2418.8,828.152,0.00138879], 285, _grouphsq] call _createVehicle];
_vehicles set [2, ["O_Heli_Light_02_armed_F", [2401.98,872.439,0.00141001], 285, _grouphsq] call _createVehicle];
...
_picture = getText (configFile >> "CfgVehicles" >> "O_Heli_Light_02_armed_F" >> "picture");
_vehicleName = getText (configFile >> "cfgVehicles" >> "O_Heli_Light_02_armed_F" >> "displayName");
