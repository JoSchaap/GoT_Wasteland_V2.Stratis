...
_createVehicle = {
    ...
    _soldier = [_group, _position] call createRandomSoldier; 
    if (_vehicle isKindOf "B_MRAP_01_F") then {
...
_vehicles = [];
_vehicles set [0, ["B_MRAP_01_hmg_F", [3272.0862, 6818.0166, 4.1839767], 110, _group] call _createVehicle];
_vehicles set [1, ["B_MRAP_01_F", [3256.6409, 6823.4746, 3.8003173], 110, _group] call _createVehicle];
_vehicles set [2, ["B_MRAP_01_gmg_F", [3240.3447, 6829.6089, 4.275979], 110, _group] call _createVehicle];
...
_picture = getText (configFile >> "CfgVehicles" >> "B_MRAP_01_F" >> "picture");
_vehicleName = getText (configFile >> "cfgVehicles" >> "B_MRAP_01_F" >> "displayName");
