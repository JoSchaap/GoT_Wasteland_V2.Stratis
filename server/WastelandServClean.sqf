...
_deathTime = 900;	// Time a body has to have been dead before cleaning it up (default: 900 = 15 minutes)
_itemDistance = 15;	// the radius around the body (mtr) in which items will be searched for removal
