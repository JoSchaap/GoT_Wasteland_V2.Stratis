...
//  ["Combat Fatigues (Tee)","U_B_CombatUniform_mcam_tshirt", 100,"uni"],
    ...
    ["Dive Rebreather(bluefor)","V_RebreatherB", 40,"vest"],
	["Dive Rebreather(others)","V_RebreatherIR", 40,"vest"],
    ["Dive Wetsuit(bluefor)","U_B_Wetsuit", 30,"uni"],
	["Dive Wetsuit(others)","U_O_Wetsuit", 30, "uni"],
    ["Ghillysuit(bluefor)","U_B_Ghilliesuit", 90,"uni"],
	["Ghillysuit(others)","U_O_Ghilliesuit", 90, "uni"],
