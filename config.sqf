...
ammoArray = [
	...
	["5.56mm 20Rnd (U.W.) Mag","20Rnd_556x45_UW_mag",5],
	...
	["408 7Rnds LRR","7Rnd_408_Mag",100],
...
accessoriesArray = [
    ...
    ["First Aid","FirstAidKit", 30,"item"],
    ["Medkit","Medikit", 150,"item"],
    ["Toolkit","ToolKit", 150,"item"],
  	["Suppressor 9mm","muzzle_snds_L", 70,"item"],
	...
	["ACO Sight","optic_Aco", 70,"item"],
    ["ACO Sight(Green)","optic_ACO_grn", 70,"item"], 
...
//  ["Combat Fatigues (Tee)","U_B_CombatUniform_mcam_tshirt", 100,"uni"],
    ...
    ["Ghillysuit(bluefor)","U_B_Ghilliesuit", 150,"uni"],
	["Ghillysuit(others)","U_O_Ghilliesuit", 150, "uni"],
